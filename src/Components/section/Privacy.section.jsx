    ...
    return (
        <section>
            <div className="containers">
             <div className="bg-expertiseColor flex flex-col gap-10 relative  py-24 px-55.25 ">
             <div className="flex flex-col gap-6">
                <h1 className="title text-primaryColor">Transform Your Idea Into Reality with Ether a Leading Digital Agency</h1>
            ...
            <div className="flex flex-col gap-4"> 
                <h2 className="text-primaryColor leading-9 text-2xl font-semibold">
            ...
            <svg className="absolute -bottom-6 left-0" width="296" height="24" viewBox="0 0 296 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="0.00012207" width="296" height="24" fill="#3A41DC"/>
                <rect x="42.7744" width="253.225" height="24" fill="#FFA155"/>
                <rect x="42.6338" y="0.0371094" width="183.541" height="23.9626" fill="#FFD3AF"/>
            </svg>
            </div>
            </div>
        </section>
